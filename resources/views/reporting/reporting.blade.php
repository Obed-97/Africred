                        ...
                        <div class="card-body">
                            <h4 class="card-title text-right mb-4">
                                ...
                                <button type="button" class="btn btn-success  waves-effect waves-light"
                                    data-toggle="modal" data-target="#staticBackdrop"><i
                                        class="  ri-arrow-down-line"></i> Encaissement</button>
                                @endif
                            </h4>
                            <div class="modal fade" id="staticBackdrop" tabindex="-1" role="dialog"
                                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form action="{{route('encaissement.store')}}" method="POST"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control " name="nature" required>
                                                        <option value="Recouvrement journalier">Recouvrement journalier
                                                        </option>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div>
                                                        <textarea name="observation" id="" cols="30" rows="5"
                                                            class="form-control"
                                                            placeholder="Donner plus de déatils sur l'encaissement"></textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button class="btn btn-success waves-effect waves-light"
                                                    type="submit"><i class="  ri-arrow-down-line"></i>
                                                    Encaisser</button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="row">
                                <div class="mb-4 col-xl-4">
                                    <h4 class="text-success mb-2"><img
                                            src="{{asset('assets/images/caisse-enregistreuse.png')}}" height="45"
                                            width="45" class="mr-2"> Total :
                                        {{number_format($encaissements->sum('montant'), 0, ',', ' ')}} CFA </h4>
                            ...
                            <table id="datatable-buttons" class="table  dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{route('encaissement.edit', $item->id)}}"
                                                class="mr-3 text-primary" data-toggle="tooltip" data-placement="top"
                                                title="" data-original-title="Voir plus"><i
                                                    class="mdi mdi-eye font-size-20"></i></a>
                                            <form method="POST" action="{{route('encaissement.destroy', $item->id)}}">
                                                @csrf
                                                {{method_field('DELETE')}}
                                                <button class="text-white btn-danger btn-rounded" data-toggle="tooltip"
                                                    data-placement="top" title="" data-original-title="Supprimer"
                                                    type="submit"><i
