                        ...
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 text-success">
                                    HISTORIQUE &nbsp; DU &nbsp; {{(new DateTime($date))->format('d-M-Y')}} 
                                </h4>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-xl-7" id="web">
                           <form  method="POST" action="{{route('historique.store')}}" class="d-flex mb-4">
                               ...
                               <div class="col-xl-2"><button type="submit"  class="btn btn-primary  waves-effect waves-light"><i class=" ri-search-2-line"></i> FILTRER</div>
                           </form>
                        </div>
                        
                           <div class="col-xl-2"><a href="{{route('historique.index')}}" class="btn btn-success btn-block  waves-effect waves-light"> HISTORIQUE DU JOUR</a></div>
                       </div>
                                    ...
                                    <table id="datatable-buttons" class="table  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Capital &agrave; ce jour</th>
                                                <th>Int&eacute;r&ecirc;t &agrave; ce jour</th>
                                                
                                                <th>&Eacute;pargne &agrave; ce jour</th>
                                                <th>Assurance</th>
                                                <th>Retrait</th>
                                                <th>Total</th>
                            ...
                            <form id="delete_modal" action="{{route('supprimer')}}" method="POST"  enctype="multipart/form-data" class="mr-2">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <h6>Rassurez-vous avant d'effectuer la suppression de cette donn&eacute;e!</h6>
                                    </div>
