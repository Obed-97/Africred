                       ...
                       <div class="col-xl-7" id="web">
                            <form  method="POST" action="{{route('depot.livret')}}" class="d-flex mb-4">
                                ...
                                <div class="col-xl-6">
                                 ...
                                 <div class="col-xl-4"><button type="submit"  class="btn btn-primary  waves-effect waves-light"><i class="ri-file-text-line font-size-16 align-middle mr-2"></i> ATTESTATION DE SOLDE</div>
                            </form>
                        </div>
                        <div class="col-xl-2"><a href="{{route('historique_depot.index')}}" class="btn btn-primary btn-block  waves-effect waves-light mb-2"><i class="  ri-file-list-3-line align-middle mr-2"></i> HISTORIQUE</a></div>
                    </div>
