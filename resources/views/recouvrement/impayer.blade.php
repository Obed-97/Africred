                ...
                <div class="container-fluid">
                        ...
                        <div class="modal-dialog" >
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel"><i class="ri-map-pin-time-line  align-middle mr-2"></i> R&eacute;&eacute;chelonnement</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <label>Date r&eacute;&eacute;chelonnement <b class="text-danger">*</b></label>
                                        <div>
                                            <input class="form-control" type="date" name="date_r"  id="date_r" required>
                                        </div>
                                     </div>
                                    <div class="col-5 form-group ">
                                        <label>D&eacute;&eacute;lai (max 40 jours) <b class="text-danger">*</b></label>
                                        <div>
                                  ...
                                  <div class="form-group mb-4 ">
                                    <label>Motif du r&eacute;&eacute;chelonnement <b class="text-danger">*</b></label>
                                    <div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-info waves-effect waves-light" type="submit"><i class="ri-map-pin-time-line  align-middle mr-2"></i> R&eacute;&eacute;chelonner</button>
                                </div>
                            </div>
                        </form>
                        </div>
                    ...
                    <div class="row" >
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 text-danger">Encours &nbsp; Global &nbsp; : &nbsp; {{number_format($encours, 0, ',', ' ')}} CFA</h4>
                    ...
                    <div class="row mb-4">
                        <div class="col-xl-2" id="web">
                           <a href="{{route('etat_actualise.index')}}" class="btn btn-success btn-block  waves-effect waves-light"><i class="ri-pushpin-fill  align-middle mr-2"></i>ENCOURS</a> 
                        ...
                        <div class="col-xl-2"><a href="{{route('journalier.index')}}" class="btn btn-primary btn-block  waves-effect waves-light"><i class="ri-funds-box-fill  align-middle mr-2"></i>D&Ucirc;S JOURNALIERS</a></div>
                    </div>
                                ...
                                <div class="card-body">
                                    <h4 class="card-title text-right mb-4">
                                            ...
                                            <button type="button" class="btn btn-info waves-effect waves-light mb-3" data-toggle="modal" data-target="#staticBackdrop">
                                                ...
                                                <i class="ri-map-pin-time-line  align-middle mr-2"></i> R&eacute;&eacute;chelonnement
                                            </button>
                                    ...
                                    <table id="datatable-buttons" class="table  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Pr&ecirc;t + Int&eacute;r&ecirc;t</th>
                                                <th>Capital recouvr&eacute;</th>
                                                <th>Int&eacute;r&ecirc;t recouvr&eacute;</th>
                                                <th>&Eacute;pargne recouvr&eacute;e</th>
                                            ...
                                            @foreach ($credits as $item)
                                                <tr>
                                                    ...
                                                    <td style = "text-transform:uppercase;">
                                                        ...
                                                        <div class="badge badge-soft-info font-size-12">R</div>
