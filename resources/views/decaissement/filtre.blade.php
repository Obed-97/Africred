                                    ...
                                    <h4 class="card-title text-right mb-4">
                                        ...
                                        <div class="row">
                                            <div class="mb-4 col-xl-4">
                                                <h4 class="text-success mb-2"><img src="{{asset('assets/images/caisse-enregistreuse.png')}}" height="45" width="45" class="mr-2"> Total : {{number_format($decaissements->sum('montant'), 0, ',', ' ')}} CFA </h4>
                                            ...
                                            @foreach ($decaissements as $item)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        ...
                                                        <form method="POST" action="{{route('decaissement.destroy', $item->id)}}">
                                                            @csrf
                                                            {{method_field('DELETE')}}
