...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 text-success">{{(new DateTime($date1))->format('d-M-Y')}} </h4>
        ...
        <div class="row mb-4">
            <div class="col-xl-4">
                <form  method="POST" action="{{route('filtre.index')}}" class="d-flex mb-4">
                    @csrf
                    <div class="col-xl-4"><input type="date" name="fdate" class="form-control"></div>
                    
                    <div class="col-xl-4"><button type="submit"  class="btn btn-primary  waves-effect waves-light">Recherche</div>
                </form>
             </div>
               <div class="col-xl-6">
                    <form  method="POST" action="{{route('filtre.store')}}" class="d-flex mb-4">
                        ...
                        <div class="col-xl-2"><button type="submit"  class="btn btn-primary  waves-effect waves-light">Filtrer</div>
                    </form>
                </div> 
