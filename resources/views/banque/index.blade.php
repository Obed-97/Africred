@section('title', 'Opérations Bancaires')
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-4">
                       ...
                       <div class="col-xl-5" id="web">
                        ...
                        <div class="col-xl-2"><a href="{{route('banque.create')}}" class="btn btn-primary btn-block  waves-effect waves-light"> OP&Eacute;RATIONS DU JOUR</a></div>
                    </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control " name="type" required>
                                                                            <option value="D&eacute;p&ocirc;t">Dépôt</option>
                                                                            <option value="R&eacute;trait">Rétrait</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
