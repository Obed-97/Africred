        ...
        <div class="container-fluid">
            ...
            <div class="container mt-4 mb-4" style=" border:1px solid white; background-color: white; color: black;">
                ...
                <div class="text-center mt-2 mb-4">
                    <H4><u><b>FICHE MEMBRE DE LA CAISSE</b></u> </H4>
                </div>
                ...
                <div class="row mt-4">
                            ...
                            <div class="flip-card-inner">
                                <div class="flip-card-front">
                                    ...
                                    <svg viewBox="0 0 48 48" height="36" width="36" y="0px" x="0px"
                                        xmlns="http://www.w3.org/2000/svg" class="logos">
                                    ...
                                    <svg xml:space="preserve" viewBox="0 0 50 50" height="30px" width="30px" y="0px"
                                        x="0px" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        xmlns="http://www.w3.org/2000/svg" id="Layer_1" class="chip" version="1.1">
                              ...
                              LTEzVDA4OjE1OjI5KzAwOjAwY2+u1gAAAABJRU5ErkJggg==" y="0" x="0" height="50" width="50"
                                    ...
                                    <svg xml:space="preserve" viewBox="0 0 50 50" height="25px" width="25px" y="0px"
                                        x="0px" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        xmlns="http://www.w3.org/2000/svg" id="Layer_1" class="contactless"
                                        version="1.1">
                              ...
                              MDowMIXeN6gAAAAASUVORK5CYII=" y="0" x="0" height="50" width="50" id="image0"></image>
                                    ...
                                    <p class="number text-white">ABF-{{$client->id}} 000 000 000 </p>

                                    <p class="date text-white">1 2 / 2 4</p>
                                    <p class="name text-white"><b
                                            style="text-transform:uppercase;">{{$client->nom_prenom}}</b></p>
                                </div>
                    ...
                    <div class="col-1">
                        <img src="/assets/images/users/{{$client->image}}" alt="" class="rounded avatar-lg">

                    </div>
                    <div class="col-md-6">
                        <ul style="text-align: justify; font-size: 20px">
                            <li style="list-style-type: none;">
                                <h6>Pr&eacute;nom & Nom : <b style="text-transform:uppercase;">
                                        {{$client->nom_prenom}}</b></h6>
                            </li>

                            <li style="list-style-type: none;">
                                <h6>Lieu de r&eacute;sidence : <b style="text-transform:uppercase;">{{$client->adresse}}
                                    </b></h6>
                            </li>
                            <li style="list-style-type: none;">
                                <h6>Profession : <b style="text-transform:uppercase;">{{$client->activite}}</b></h6>
                            </li>
                            <li style="list-style-type: none;">
                                <h6>Téléphone : <b style="text-transform:uppercase;">{{$client->telephone}}</b> </h6>
                            </li>

                            <li style="list-style-type: none;">
                                <h6>Date de naissance <b style="text-transform:uppercase;">{{(new
                                        DateTime($client->date_n))->format('d-M-Y')}}</b> </h6>
                            </li>
                            <li style="list-style-type: none;">
                                <h6>Lieu de naissance : <b style="text-transform:uppercase;">{{$client->lieu_n}}</b>
                                </h6>
                            </li>
                    ...
                    <div class="col-1">
                        ...
                        <img src="/assets/images/default-logo.png" alt="" class="rounded avatar-lg">
                        @else
                        <img src="/assets/images/{{$client->image}}" alt="" class="rounded avatar-lg">
                        @endif
                    ...
                    <div class="col-md-6">
                        <ul style="text-align: justify; font-size: 20px">
                            <li style="list-style-type: none;">
                                <h6>Raison sociale : <b style="text-transform:uppercase;"> {{$client->nom_prenom}}</b>
                                </h6>
                            </li>
                            <li style="list-style-type: none;">
                                <h6>Forme juridique : <b style="text-transform:uppercase;">
                                        {{$client->forme_juridique}}</b></h6>
                            </li>
                            ...
                            <li style="list-style-type: none;">
                                <h6>Date de création <b style="text-transform:uppercase;">{{(new
                                        DateTime($client->date_n))->format('d-M-Y')}}</b> </h6>
                            </li>
                            <li style="list-style-type: none;">
                                <h6>Siège : <b style="text-transform:uppercase;">{{$client->lieu_n}}</b> </h6>
                            </li>
                ...
                <div class="row ml-2 mt-4 mb-5">
                    ...
                    <div class=" col-md-2 mb-5">
                        <h5> <b><u>Signature </u></b></h5>
                        <img src="{{asset('assets/images/R-removebg-preview.png')}}" width="150" height="100">
                    </div>
                </div>
