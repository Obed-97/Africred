                ...
                <div class="container-fluid">
                    ...
                    <div class="row" >
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 text-success">Cr&eacute;dits &nbsp; encours &nbsp; : &nbsp; {{number_format($sum_montant, 0, ',', ' ')}} CFA</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0" id="web">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Africred</a></li>
                                        <li class="breadcrumb-item active">Cr&eacute;dits encours</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-xl-3 mb-2">
                             <div class="btn-group" role="group">
                                <button id="btnGroupVerticalDrop1" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ABEYAN SUGU <i class="mdi mdi-chevron-down"></i>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                    <a class="dropdown-item" href="{{route('credit.index')}}">ABEYAN FOU</a>
                       ...
                       <div class="col-xl-7" id="web">
                        ...
                        <div class="col-xl-2"><a href="{{route('etat_credit.index')}}" class="btn btn-success btn-block  waves-effect waves-light"> D&Eacute;BLOCAGE DU JOUR</a></div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="mb-4 col-xl-4">
                                                ...
                                                <a href="{{route('credit.marche')}}" class="btn btn-success btn-sm waves-effect waves-light"><i class="ri-store-2-line "></i> March&eacute;</a>  
                                                @else
                                                <a href="{{route('credit.index')}}" class="btn btn-success btn-sm waves-effect waves-light mr-2"><i class="ri-user-3-line"></i> Client</a>
                                    ...
                                    <table id="datatable-buttons" class="table  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>March&eacute;</th>
                                                <th>Date d&eacute;blocage</th>
                                                
                                                <th>Nbre jours</th>
                                                <th>Capital & Int&eacute;r&ecirc;t</th>
                                            ...
                                            @foreach ($credits as $item)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        ...
                                                        <a href="{{route('nano.show', $item->id)}}" class="mr-3 text-secondary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Contrat de pr&ecirc;t"><i class="mdi mdi-eye font-size-18"></i></a>
                                                        <button  class="text-white btn-danger btn-rounded creditBtn" value="{{$item->id}}"  data-original-title="Supprimer" type="button" data-toggle="modal" data-target="#credit"><i class="mdi mdi-trash-can font-size-18"></i></button> 
                                                        @endif
