    ...
    <div class="page-content">
        ...
        <div class="container mt-4 mb-4" style=" border:1px solid white; background-color: white; color: black;">
            ...
            <div class="text-center mt-2 mb-2">
                <H4><u><b>CONTRAT DE PR&Ecirc;T ET DE RECONNAISSANCE DE DETTE ABEYAN SUGU</b></u> </H4>
            </div>
                ...
                <div class="col-md-4">
                    <table  class="table border dt-responsive nowrap " style = "color: black;" >
                        ...
                        <tr>
                            ...
                            <td> 5 % </td>
                            @elseif(($credit->interet/$credit->montant) == 0.25)
                            <td> 25 % </td>
                            @elseif(($credit->interet/$credit->montant) == 0.3)
                            <td> 30 % </td>
                            @elseif(($credit->interet/$credit->montant) == 0.35)
                            <td> 35 % </td>
                            @elseif(($credit->interet/$credit->montant) == 0.4)
                            <td> 40 % </td>
                            @elseif(($credit->interet/$credit->montant) == 0.45)
                            <td> 45 % </td>
                            @elseif(($credit->interet/$credit->montant) == 0.5)
                            <td> 50 % </td>
                            @endif
        ...
        <div class="row mt-4">  
            ...
            <div class="col-md-10">
                <p style="text-align: justify; font-size: 17px">
                    ...
                    Le cr&eacutedit sera rembours&eacute en deux tranches de : <b style = "text-transform:uppercase;"> {{number_format(($credit->montant_interet / 2 ), 0, ',', ' ')}} CFA</b><br>
                    <ul>
                        <li>1&egrave;re Tranche : {{(new DateTime($tranche1))->format('d-m-Y')}}</li>
                        <li>2&egrave;me Tranche : {{(new DateTime($tranche2))->format('d-m-Y')}}</li>
                    </ul>
                    <p style="text-align: justify; font-size: 17px">
