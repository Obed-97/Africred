                               ...
                               <div class="row">
                                   <div class="col-xl-8">
                                       <div class="form-group ">
                                            <label>Montant</label>
                                            <div>
                                                <input class="form-control" min="50000" type="number" name="montant"  id="montant" required>
                                            </div>
                                        </div>
                                   </div>
                                   <div class="col-xl-4">
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-xl-2" id="web">
                         <a href="{{route('wait.create')}}" class="btn btn-primary btn-block text-white  waves-effect waves-light" >ROTATIONS</a>
                     </div>
                     <div class="col-xl-2" id="web"></div>
                       <div class="col-xl-7" id="web">
                            <form  method="POST" action="{{route('wait.store')}}" class="d-flex mb-4">
                                @csrf
                                <div class="col-xl-6">
                                    <select class="form-control select2" name="client_id" required>
                                        @foreach ($clients as $item)
                                                        ...
                                                        @if (auth()->user()->role_id == 1 )
                                                            ...
                                                            @else
                                                                <button type="button" class="btn btn-success btn-sm waves-effect waves-light mr-2 deblocageBtn" value="{{$item->id}}"  data-toggle="modal" data-target="#date_deblocage">
                                                                    <i class="ri-check-line align-middle mr-2"></i> Accorder
                                                                </button>
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        ...
                        <div class="modal fade" id="date_deblocage" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form method="POST" action="{{route('wait.update', $item->id)}}" enctype="multipart/form-data" class="mr-2">
                                    @csrf
                                  {{method_field('PUT')}}
                                    <div class="modal-content">
                                        <div class="modal-header">
